...
/* ── User variables (A–F, x, y, z) ── */
#define SETTINGS_VAR_COUNT 9
double settings_get_variable(int idx);          /* 0=A..5=F, 6=x, 7=y, 8=z */
void   settings_set_variable(int idx, double v);
char   settings_get_variable_name(int idx);     /* 'A'..'F', 'x','y','z'    */
